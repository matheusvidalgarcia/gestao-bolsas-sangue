...
namespace GestaoBolsaSangue.Infra.Data.Context
{
    public sealed class BolsaSangueContext : IMongoContext, IUnitOfWork
    {
        private IMongoDatabase Database { get; set; }
        public MongoClient MongoClient { get; set; }
        private readonly List<Func<Task>> _commands;
        public IClientSessionHandle Session { get; set; }
        public BolsaSangueContext(IConfiguration configuration)
        {
